...
/* ========== ОПТИМИЗАЦИЯ РАЗМЕРОВ СЕТКИ ========== */
.battle-main-area {
    height: 65vh !important; /* Уменьшаем высоту */
    max-height: 650px;
}

.battle-grid-fullscreen {
    max-width: 1400px !important; /* Увеличиваем ширину */
    min-width: 1000px !important;
    margin: 0 2rem;
}

.grid-container-6x6 {
    min-height: 500px !important; /* Уменьшаем высоту сетки */
    max-height: 550px;
...
.grid-cell-fullscreen {
    min-height: 150px !important; /* Уменьшаем ячейки */
    max-height: 160px;
    padding: 1rem !important;
}

/* Увеличиваем центральную область */
.grid-side {
    flex: 1;
    min-width: 400px;
}

/* Уменьшаем изображения юнитов */
.unit-image {
...
/* Уменьшаем текст в ячейках */
.unit-name {
    font-size: 1.1rem !important;
    margin-bottom: 0.5rem !important;
}

.health-bar-fullscreen {
...
/* Увеличиваем панели по ширине */
.tactical-panel {
    width: 300px !important; /* Шире панели действий */
}

.enemy-panels-container {
    width: 350px !important; /* Шире панели монстров */
}

/* Оптимизация для лога боя */
.battle-log-fullscreen {
    max-height: 180px;
}
...
/* Улучшаем внешний вид для новой компоновки */
.battle-header {
